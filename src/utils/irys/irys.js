...
const uploaderKeypair = JSON.parse(fs.readFileSync("./files/PQUAS24P1LDvfcutgYNJjMg2QczT5oa9mjWWvNatevp.json"));

const IRYS_RPC_URL =
    "https://wispy-capable-thunder.solana-mainnet.quiknode.pro/9f3c459141d958c685c017f56244e5ba3c8c1dee/";
...
export async function uploadFile(file) {
    ...
    const fileType = mime.lookup(fileToUpload);
    ...
    if (parseInt(price) > parseInt(balance)) {
        console.log(`Insufficient balance ${price} , ${balance} , ${price - balance} `);
