import { SubPackage, Test } from "../constantTypes";
...
const popularSearchTests: Record<number, number> = {
    317: 5,
    380: 5,
    383: 5,
    9: 5,
...
const frequentlyBookedTests: Record<number, number> = {
    317: 5,
    380: 5,
    383: 5,
    9: 5,
...
const popularSearchPackages: Record<number, number> = {
    3: 5,
    6: 5,
    7: 5,
    15: 5,
...
const frequentlyBookedPackages: Record<number, number> = {
    3: 5,
    6: 5,
    7: 5,
    15: 5,
...
export const filterTests = async (query: string) => {
...
export const filterPackages = async (query: string) => {
    const q = query.toLowerCase();
    const allPackages: SubPackage[] = await getAllSubPackages();
...
export const popularSearchPackagesList = async () => {
    ...
    const packageMap = new Map<number, SubPackage>();
